            ...
            <div class="container">
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-4 mt-3">
                    ...
                    <a href="#" class="rounded-md overflow-hidden relative w-full lg:h-48 h-40">
                        ...
                        <img src="http://demo.foxthemes.net/courseplus-v4.3.1/assets/images/category/it-and-software.jpg" class="absolute w-full h-full object-cover" alt="">
                    ...
                    <a href="#" class="rounded-md overflow-hidden relative w-full lg:h-full h-40 lg:row-span-2">
                        ...
                        <img src="http://demo.foxthemes.net/courseplus-v4.3.1/assets/images/category/marketing.jpg" class="absolute w-full h-full object-cover" alt="">
                    ...
                    <a href="#" class="rounded-md overflow-hidden relative w-full lg:h-48 h-40">
                        ...
                        <img src="http://demo.foxthemes.net/courseplus-v4.3.1/assets/images/category/photography.jpg" class="absolute w-full h-full object-cover" alt="">
